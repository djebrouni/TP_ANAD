...
qual_vars <- c(
  "Category", "Gender", "Season", "Payment.Method", 
  "Frequency.of.Purchases", "Item.Purchased", "Location", "Size"
)
...
for (v in qual_vars) {
  ...
  if (length(freq) == 0) {
    cat("\n### Tableau de fréquences pour :", v, "est vide, aucun graphique.\n")
    next
  }
  ...
  barplot(freq, main=paste("Barplot of", v),
